...
from typing import Optional, TypedDict, Unpack, TypeAlias, overload
...
class Conversation(BaseModel):
    ...
    def add_message(self, **message: Unpack[MessageParam]) -> 'Conversation':
        ...
        match message:
            ...
            case _:
                raise TypeError("Must be called with either user or assistant parameter")
        return self     
    ...
    def compile(self) -> list[dict[str, str]]:
        ...
        payload = [self.system_prompt.model_dump()] if self.system_prompt else []
        payload.extend(self.memory.model_dump())
        return payload